...
function M.setup(opts)
  ...
  local colors = require("carbon.colors").setup(opts)
  local groups = require("carbon.groups").setup(colors, opts)

  if vim.g.colors_name then vim.cmd("hi clear") end

  vim.o.termguicolors = true
  vim.g.colors_name = "carbon-" .. opts.style
  ...
  if opts.terminal_colors then M.terminal(colors) end
