...
function M.get(c, opts)
  return {
    ...
    TelescopePromptBorder = { fg = c.blue, bg = c.bg_float },
    TelescopePromptTitle = { fg = c.blue, bg = c.bg_float },
    TelescopeResultsTitle = { fg = c.blue, bg = c.bg_float },
    -- nvim-cmp
    CmpDocumentation = { fg = c.fg, bg = c.bg_float },
    CmpDocumentationBorder = { fg = c.border_highlight, bg = c.bg_float },
    CmpItemAbbr = { fg = c.fg, bg = c.none },
    CmpItemAbbrMatch = { fg = c.blue, bg = c.none },
    CmpItemMenu = { fg = c.fg_dark, bg = c.none },
    -- Git Signs
